...
const components = [
  ...
  { name: 'AdminViewManager', label: 'Layouts' },
  { name: 'AdminWorkflowManager', label: 'Workflow' },
  { name: 'AdminAppManager', label: 'Apps' },
  { name: 'AdminSSOConfig', label: 'Login & Single Sign-On' },
  { name: 'AdminApiTokens', label: 'API & Service Tokens' },

...
| Piece | Value |
|---|---|
| Runtime | **Bun >= 1.4.0** (`oven/bun:1.4` Docker images) |
...
| Deployment Guide | `docs/DEPLOYMENT_PREREQUISITES.md` |
...
- **Docs**: `docs/` — see especially `docs/DEPLOYMENT_PREREQUISITES.md` (deployment prerequisites & ops), `docs/ZONING_ARCHITECTURE.md` (zoning model), `docs/KB_UNLOADED_CONFIG.md` (diagnosis playbook) and `docs/CREATE_APP_NAV.md`.
